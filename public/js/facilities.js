...
$(function(){    
    $.get("/facilities", function(data){
        ...
        for (i = 0; i < data.length; i++){
            ...
            //$("#facilities .request-result").append('<div class="col-12 col-md-6 col-lg-4 mb-4"><div class="card"><img class="card-img-top" src="img/'+imagePath+'" alt="Card image cap"><div class="card-body"><h5 class="card-title">'+roomName+'</h5><p class="card-text">'+roomDescription+'</p><a id="'+roomId+'" class="btn btn-primary facilityLink">Go somewhere</a></div></div></div>')
            
            $('<div class="col-12 col-md-6 col-lg-4 mb-4"><div class="card"><img class="card-img-top" src="img/'+imagePath+'" alt="Card image cap"><div class="card-body"><h5 class="card-title">'+roomName+'</h5><p class="card-text">'+roomDescription+'</p><a id="'+roomId+'" class="btn btn-primary facilityLink">Go somewhere</a></div></div></div>').hide().appendTo("#facilities .request-result").fadeIn(600)
...
$("#facilities .request-result").on("click", ".facilityLink", function(){
    ...
    $.get("/facilities/"+facilityId, function(data){
        ...
        $("#facilities .request-result").html(" ");
        $("#facilities .request-result").append("<img class='col-6' src=" + imagePath + " />")
        $("#facilities .request-result").append("<div class='col-6'><h2>" + roomName + "</h2><p>" + roomDescription + "</p></div>")
