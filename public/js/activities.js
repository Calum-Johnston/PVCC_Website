...
function loadactivities(){
    $.get("/activities", function(data){
        ...
        for (i = 0; i < data.length; i++){
            ...
            $('<div class="col-12 col-md-6 col-lg-4 mb-4"><div class="card"><img class="card-img-top" src="'+imagePath+'" alt="Card image cap"><div class="card-body"><h5 class="card-title">'+activityName+'</h5><p class="card-text">'+activityDescription+'</p><a id="'+activityId+'" class="btn btn-primary activityLink">Go somewhere</a></div></div></div>').hide().appendTo("#activities .request-result").fadeIn()
...
$("#activities .request-result").on("click", ".activityLink", function(){
    ...
    $.get("/activities/"+activityId, function(data){
        ...
        $('<button type="button" class="btn btn-primary" id="goBack">Go Back</button>').hide().appendTo("#activities .request-result div").fadeIn()
